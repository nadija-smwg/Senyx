...
export function DealsClient({ initialDeals, initialAccounts }: { initialDeals: Deal[], initialAccounts: Account[] }) {
  ...
  // We sync state with props if they change from a server action / refresh
  useEffect(() => {
    setDeals(initialDeals);
    setAccounts(initialAccounts);
  }, [initialDeals, initialAccounts]);
    ...
    <CrmPageShell
      ...
      actions={
        <>
          ...
          />
          <DealSheet onSaved={() => router.refresh()} />
        </>
      }
      stats={
        <>
